...
async function main() {
    ...
    const ImplementationContract = await Implementation.deployContract();
    // await ImplementationContract.deployed();
    console.log("ImplementationContract deployed at:", await ImplementationContract.address);
    ...
    const ProxyContract = await Proxy.deployContract(ImplementationContract.address);
